...
It looks like your README.md is appearing as one long block of text because Markdown requires specific spacing (newlines) to render headings, lists, and tables correctly.

Here is the "fixed" code. I have adjusted the spacing so that when you copy, paste, and commit, it will look exactly like the beautiful structured version you want.
